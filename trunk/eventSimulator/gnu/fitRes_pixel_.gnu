...
s = 20.
fit f(x) \
  "<awk '{if($$1==$0) print}' ../out/result_pixels.dat | \
   histogram  4 -100. 100. 200 -" via a,s
sx1 = abs(s); sx1_e = s_err

s = 20.
fit f(x) \
  "<awk '{if($$1==$0) print}' ../out/result_pixels.dat | \
   histogram  8 -100. 100. 200 -" via a,s
sx2 = abs(s); sx2_e = s_err

s = 20.
fit f(x) \
  "<awk '{if($$1==$0) print}' ../out/result_pixels.dat | \
   histogram 12 -100. 100. 200 -" via a,s
...
fit f(x) \
  "<awk '{if($$1==$0) print}' ../out/result_pixels.dat | \
   histogram  5 -100. 100. 200 -" via a,s
sy1 = abs(s); sy1_e = s_err

s = 20.
fit f(x) \
  "<awk '{if($$1==$0) print}' ../out/result_pixels.dat | \
   histogram  9 -100. 100. 200 -" via a,s
sy2 = abs(s); sy2_e = s_err

s = 20.
fit f(x) \
  "<awk '{if($$1==$0) print}' ../out/result_pixels.dat | \
   histogram 13 -100. 100. 200 -" via a,s
...
s = 5.
fit g(x) \
  "<awk '{if($$1==$0 && $$16!=0.) print}' ../out/result_pixels.dat | \
